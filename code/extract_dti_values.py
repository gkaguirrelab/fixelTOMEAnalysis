...
def extract_dti_values(metric_images, workdir, output_folder_path, left_track, right_track, tckmap_template, mrtrix_path='', freesurfer_path='', ants_path='', fslpath='', track_density_thresh='1', binary_threshold='1'):
